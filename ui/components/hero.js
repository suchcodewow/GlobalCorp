...
export default function Hero() {
  return (
    <>
      <div className="relative overflow-hidden drop-shadow">
        <div className="mx-auto">
          <div className="relative z-10 bg-white pb-8 sm:pb-16 md:pb-20 lg:w-full lg:max-w-6xl lg:pb-28 xl:pb-32">
            <svg
